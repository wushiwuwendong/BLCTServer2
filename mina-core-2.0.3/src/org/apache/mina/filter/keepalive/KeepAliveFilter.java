...
public class KeepAliveFilter extends IoFilterAdapter {
	...
	/**
	 * Returns <tt>true</tt> if and only if this filter forwards a
	 * {@link IoEventType#SESSION_IDLE} event to the next filter. By default,
	 * the value of this property is <tt>false</tt>.
	 */
