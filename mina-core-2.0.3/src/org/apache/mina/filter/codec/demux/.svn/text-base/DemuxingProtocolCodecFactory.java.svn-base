...
/**
 * 提供一个方便的{@link ProtocolCodecFactory}，它提供的一对{@link DemuxingProtocolEncoder}
 * 和 {@link DemuxingProtocolDecoder}。
 * <p>
 * {@link DemuxingProtocolEncoder} 和 {@link DemuxingProtocolDecoder} 多路分离传入的消息，并适当的将 {@link MessageEncoder}s 和 
 * {@link MessageDecoder}s存到到缓冲区。
 *
