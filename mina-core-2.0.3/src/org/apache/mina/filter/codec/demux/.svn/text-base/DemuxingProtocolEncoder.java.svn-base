...
/**
 * 复合的{@link ProtocolEncoder}信号分离器，将传入的请求消息放到适当的{@link MessageEncoder}进行编码。
 * 
 * <h2>通过{@link MessageEncoder}回收废弃资源</h2>
 * <p>
 * 覆盖{@link #dispose(IoSession)}方法。请不要忘记调用 <tt>super.dispose()</tt>.
 * 
