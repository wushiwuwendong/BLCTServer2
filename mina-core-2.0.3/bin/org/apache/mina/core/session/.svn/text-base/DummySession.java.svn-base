...
/**
 * 一个用于{@link IoSession}单元测试或非网络使用的工具，本类取决于{@link IoSession}.
 * 
 * <h2>覆盖的I/O请求的方法</h2> 所有的I/O请求方法 (i.e.
 * {@link #close()}, {@link #write(Object)} 和
 * {@link #setTrafficMask(TrafficMask)}) 是最终的，因此不能被重写, 但你总是可以添加自定义{@link IoFilter} 到
 * {@link IoFilterChain}用来拦截任何I/O事件和请求.
 * 
 * @author <a href="http://mina.apache.org">Apache MINA Project</a>
 */
public class DummySession extends AbstractIoSession {

	private static final TransportMetadata TRANSPORT_METADATA = new DefaultTransportMetadata("mina", "dummy", false, false, SocketAddress.class,
	...
	/**
	 * Sets the socket address of local machine which is associated with this
	 * session.
	 */
	 ...
	 * interval}. If, however, <tt>force</tt> is specified as <tt>true</tt>,
	 * this method updates the throughput properties immediately.
	 */
